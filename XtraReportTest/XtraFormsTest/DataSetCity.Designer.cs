...
namespace XtraFormsTest.DataSetCityTableAdapters {
    ...
    public partial class CityTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[City] SET [name] = @name WHERE (([id] = @Original_id) AND ((@IsNull" +
                "_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)));\r\nSELECT id, name F" +
                "ROM City WHERE (id = @id)";
        ...
        public virtual int Fill(DataSetCity.CityDataTable dataTable) {
        ...
        public virtual DataSetCity.CityDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSetCity.CityDataTable dataTable = new DataSetCity.CityDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSetCity.CityDataTable dataTable) {
